...
const FetchFeaturedProducts = ({ featuredProducts }) => {
    ...
    <div className="py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
         ...
         ${isStartDisabled ? "bg-gray-400 cursor-not-allowed" :"bg-emerald-600 hover:bg-emerald-500"} p-2
         ...
         ${isEndDisabled ? "bg-gray-400 cursor-not-allowed" :"bg-emerald-600 hover:bg-emerald-500"} p-2
          rounded-full transition-colors duration-300 flex items-center justify-center
          `}>
