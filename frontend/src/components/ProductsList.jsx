...
const ProductsList = () => {
  const {products , deleteProduct , toggleFeaturedProduct, fetchAllProducts} = useProductStore();
     useEffect(() => {
         fetchAllProducts();
     },[fetchAllProducts]);
              ...
              <td className='px-6 py-4 whitespace-nowrap '>
                <div className='flex items-center'>
                  <div className='flex-shrink-0 h-10 w-10'>
                    <img src={product.image} className='h-10 w-10 rounded-full object-cover' 
                    alt={product.name} />
                  </div>
                  <div className='ml-4'>
